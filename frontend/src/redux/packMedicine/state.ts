...
export interface IDrugDetailStatus{
    drugDetailId: number;
    drugRecentStage: number;
}

export interface IElderlyIndividualDrugRecordsState {
    elderlyIndividualDrugRecord: IPerMedicineRecordCard,
    drug_detail_status_storage: IDrugDetailStatus[]
}
